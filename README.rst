...
We will continue to use **Gradescope** for submissions, and a link
to the starter code will be provided on Canvas.

* As usual, you will have **three** submission attempts to Gradescope.

* Compiler and run-time errors *do* count as a submission

**NO LATE SUBMISSIONS WILL BE ACCEPTED**, not even with the use of slip 
days.

Single Deliverable: Due 11:59pm May 14, 2021
--------------------------------------------
...
-  As long as they are present on Isengard, you are
   ...
   ``<bitset>``, ``<map>``, ``<queue>``, etc.
        ...
        - You are *NOT* allowed to use external libraries (e.g., ``boost``): you are only
...
#. ``./make-submission.sh`` runs without error

#. The ``zip`` file made by ``./make-submission.sh`` is uploaded to Gradescope correctly.
